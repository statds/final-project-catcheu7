...
figure, [[ax,ax2,ax3], [ax4,ax5,ax6],[ax7,ax8,ax9],[ax10,ax11,ax12]] = plt.subplots(4,3)
...
def up(z):
	...
	akg = gm['State'].isin('Alaska')
	akg.plot(column = 'Percentage', cmap = 'cool', ax = ax2)
	akg.plot(column = 'Percertage', cmap = 'cool', ax = ax5)

	akg.plot(column = 'Percertage', cmap = 'cool', ax = ax8)
	akg.plot(column = 'Percertage', cmap = 'cool', ax = ax11)
