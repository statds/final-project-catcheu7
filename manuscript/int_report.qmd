...
def up(z):
	...
	akg.plot(column = 'Percentage', cmap = 'cool', ax = ax2, vmin = 7, vmax = 10)
	ax2.set_xlim(-170,-140)
	#akg.plot(column = 'Percentage', cmap = 'cool', ax = ax)

	#akg.plot(column = 'Percentage', cmap = 'cool', ax = ax3)
	akg.plot(column = 'Percentage', cmap = 'cool', ax = ax4)
	hi = gm[gm['State'].isin(['Hawaii'])]
	hi.plot(column = 'Percentage', cmap = 'cool', ax = ax3, vmin = 7, vmax = 10)
