...
Diabetes is widespread in the United States, but the Center of Disease Control and Prevention indicates that some states having higher incident rates than others.
Studies such as one in 2019 by Liu et al. modelled risk factors such as obesity of patients to correlate the factors and the rates.
A state's demographics could amplify risk factors to increase the rates of diabetes. Understanding how interactions between demographic and risk factors can better prepare policies that can help mitigate and prevent diabetes from rising in the country.
