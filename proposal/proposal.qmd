...
A state's demographics could amplify risk factors which can increase the rates of diabetes. Understanding how interactions between demographic and risk factors can better prepare policies to mitigate and prevent diabetes from rising in the country.
