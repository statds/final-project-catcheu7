...
Matplotlib and geopandas will be used to animate the maps of the United States via color coding for each of the variables used in analysis. 2000 - 2018 data will be used due to the sparsity of 2020 data for high glucose test readings.
