...
Studies such as one in 2019 by Liu et al. correlated risk factors such as obesity of patients against the rates.
A state's demographics could amplify risk factors to increase the rates of diabetes. Understanding how interactions between demographic and risk factors can better prepare policies to mitigate and prevent diabetes from rising in the country.
