...
Studies such as one done in 2019 by Liu et al. modelled risk factors such as obesity of patients to correlate the factors and the rates.
However, a state's demographics could amplify risk factors to increase the rates of diabetes. Understanding how interactions between demographic and risk factors can better prepare policies that can help mitigate and prevent diabetes from rising in the country.
